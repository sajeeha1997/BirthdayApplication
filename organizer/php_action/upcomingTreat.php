				...
				{	
					...
					while($record = mysqli_fetch_array($exec))
					{
						...
						echo "<tr>
                            ...
                            <td>"."<button type='button' class='btn_sub' id='btnConfirmed-".$traetID."'onclick='statusChange(this.id)'>Confirmed</button> <button type='button' id='btnCelebrated-".$traetID."' onclick='statusChange(this.id)' >Celebrated</button> <button type='button' id='btnCancelled-".$traetID."' onclick='statusChange(this.id)' >Cancel</button> "."</td>
